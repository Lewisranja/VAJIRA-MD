...
global.owner = process.env.OWNER_NUMBER  || '254794021729' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7Ud1CLBY#_8DP-OnfeimXF3TtnxrcYpILd2Ak6BZVsJUqXIpEgBY' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "254794021729" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'LEWIS' ,
